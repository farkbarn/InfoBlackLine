<section class='redpie'><h6></h6>
	...
	<li class='gp' id='gp'><a rel='Google+' href="javascript:void(0);" onclick='<?php echo 'window.open("https://plus.google.com/share?url='.get_permalink().'&t='.get_the_title().'&gpsrc=gplp0&pli=1'; ?>","ventanacompartir", "toolbar=0, status=0, width=650, height=450");'><span class='icon-google-plus3'></span></a></li>
	<li class='in' id='in'><a rel='Instagram' href="javascript:void(0);" onclick='<?php echo 'window.open("https://telegram.me/share/url?url='.get_permalink().'&text='.get_the_title(); ?>","ventanacompartir", "toolbar=0, status=0, width=650, height=450");'><span class='icon-telegram'></span></a></li>
    </ul>
</section>
