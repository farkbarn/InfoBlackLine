<section class='redpie'><h6></h6>
	...
	<li class='in' id=''><a rel='Telegram' href="javascript:void(0);" onclick='<?php echo 'window.open("https://telegram.me/share/url?url='.get_permalink().'&text='.get_the_title(); ?>","ventanacompartir", "toolbar=0, status=0, width=650, height=450");'><span class='icon-telegram'></span></a></li>
    </ul>
</section>
