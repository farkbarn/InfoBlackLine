...
<html lang="es">
	<head>
		...
		<title>El Informador - Diario Venezolano</title>
	</head>
	<body>
			...
			<header class='cabezal' id='cabezal'>
				<section class='encabezado'>
					...
					<section class='menu color2'>
						<nav>
							<ul class='menugrupo'>
								<li id="item-ini"><a class="" href="#">Inicio</a><div class="item-pie-ini bgini"></div></li>
								<li id="item-lar"><a class="" href="#">Lara</a><div class="item-pie-lar bglar"></li>
								<li id="item-nac"><a class="" href="#">Nacionales</a><div class="item-pie-ini bgnac"></li>
								<li id="item-int"><a class="" href="#">Internacionales</a><div class="item-pie-ini bgint"></li>
								<li id="item-dep"><a class="" href="#">Deportes</a><div class="item-pie-ini bgdep"></li>
								<li id="item-suc"><a class="" href="#">Sucesos</a><div class="item-pie-ini bgsuc"></li>
								<li id="item-act"><a class="" href="#">Actualidad</a><div class="item-pie-ini bgact"></li>
								<li id="item-eco"><a class="" href="#">Econom&iacute;a</a><div class="item-pie-ini bgeco"></li>
								<li id="item-tec"><a class="" href="#">Salud y Belleza</a><div class="item-pie-ini bgtec">
							</ul>
						</nav>
					</section>
				</section>
...
<!-- FIN COLUMNISTA -->
			...
			<footer>
				<section class='pie'>
					...
					<section class='redpie'>
						<ul class=''>
							<li class='tg' id='tg'><a href='https://telegram.me/elinformadorve' alt='Telegram'><span class="icon-telegram"></span></a></li>
							<li class='tw' id='tw'><a href='https://twitter.com/elinformadorve' alt='Twitter'><span class='icon-twitter3'></span></a></li>
							<li class='fb' id='fb'><a href='https://www.facebook.com/elinformadorve/' alt='Facebook'><span class='icon-facebook3'></span></a></li>
							<li class='yt' id='yt'><a href='https://www.youtube.com/channel/UCPb4vjcbn4j0BQ_RQ-72X6Q/' alt='YouTube'><span class='icon-youtube4'></span></a></li>
							<li class='gp' id='gp'><a href='https://plus.google.com/b/107602064440905060759/+ElinformadorVe/' alt='Google+'><span class='icon-google-plus3'></span></a></li>
							<li class='in' id='in'><a href='https://instagram.com/elinformadorve' alt='Instagram'><span class='icon-instagram'></span></a></li>
							<li class='rs' id='rs'><a href='http://www.elinformador.com.ve/feed' alt='RSS'><span class='icon-feed4'></span></a></li>
						</ul>
					</section>
				</section>
			</footer>
