...
<!-- INICIO NOTA COL1 -->
						    ...
						    <?php if ($i==($_SESSION['nsli']+$_SESSION['npsli']+$_SESSION['nads'])){if ($_SESSION['ads']){include('ads4.php');}}?>
						    <?php if ($i==($_SESSION['nsli']+$_SESSION['npsli']+($_SESSION['nads']*2))){if ($_SESSION['ads']){include('ads5.php');}}?>
						    <?php $i++; endwhile; ?>
						    <?php wp_reset_query(); ?>
<!-- FIN NOTA COL1 -->
						</section>
