...
function downloadJSAtOnload(){
	...
	window.attachEvent("onload", downloadJSAtOnload);
		...
		<?php if ($_SESSION['wid']>=$_SESSION['adE']){/*echo "$('#adE').bjqs({'width':230,'height':100,'responsive':true,'showcontrols':false,'showmarkers':false,'randomstart':true,'animspeed':60000});";*/}?>
		<?php if ($_SESSION['wid']>=$_SESSION['adsF']){/*echo "$('#adsF').bjqs({'width':230,'height':200,'responsive':true,'showcontrols':false,'showmarkers':false,'randomstart':true,'animspeed':60000});";*/}?>
