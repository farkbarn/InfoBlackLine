						...
						<section>
							...
							<figcaption class='piefotnot'>
								...
								<section class='redpie'>
									...
									<li class='in' id='in'><a alt='Instagram' href="javascript:void(0);" onclick='<?php echo 'window.open("https://telegram.me/share/url?url='.get_permalink().'&text='.get_the_title(); ?>","ventanacompartir", "toolbar=0, status=0, width=650, height=450");'><span class='icon-instagram'></span></a></li>
								    </ul>
								</section>
							</figcaption>
						    </figure>
