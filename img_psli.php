<?php
								...
								$param=array(
										'class'=>'lazyload img imgpsli',
										'alt'=>get_the_title(),
										'title'=>get_the_title(),
										'data-src'=>wp_get_attachment_image_url(get_post_thumbnail_id(),'psli'),
										'data-srcset'=>
								...
								}else{echo "<img class='img imgpsli' src='".$_SESSION['dirtem']."img/cargando_365x183.gif'>";}
?>